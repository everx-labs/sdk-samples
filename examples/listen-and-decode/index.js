    ...
    try {
        ...
        await hello.subscribeMessages("boc", async (msg) => {
            try {
                ...
                // Message that was generated for on-chain contract call
                case MessageBodyType.Input:
                    console.log(`External inbound message, function "${decoded.name}", parameters: `, JSON.stringify(decoded.value));
                    break;
                // External outbound message generated by function's `return` 
                case MessageBodyType.Output:
                    ...
                    break;
                // External outbound message that generated as the contract's event (from event abi section)
