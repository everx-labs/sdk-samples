...
class WalletV4 {
    ...
    public async buildSimpleSend (
        ...
        const biba = () => [
            ...
            u8(0),                         // op: simple send
            u8(3),                         // mode
            builderOpCell([ // ref to internal msg
                // -------- build header --------
                b0,     // int_msg_info$0
                b0,     // ihr_disabled
                u1(bounce ? 1 : 0),
                b0,     // bounced
                b0, b0, // src: addr_none$00
                builderOpAddress(to), // dest
                u(sizeVUI, sizeBytesVUI), u(sizeBitsVUI, value), // Grams
                b0, // ExtraCurrencyCollection
                u(sizeVUI, 0), u(sizeVUI, 0), // ihr_fee, fwd_fee as zero grams
                u64(0), // created_lt
                u64(0),  // created_at
                // ------------------------------
                b0,     // state init
