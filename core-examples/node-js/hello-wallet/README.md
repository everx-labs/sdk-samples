...
In this example we deploy solidity contract Hello.sol to [Evernode SE](https://docs.evercloud.dev/products/simple-emulator-se) (local blockchain), run its on-chain method (without and with parameters) and run its get-method.
